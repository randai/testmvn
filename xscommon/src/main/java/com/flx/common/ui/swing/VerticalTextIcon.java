...
/**
 VerticalTextIcon is an Icon implementation which draws a short string vertically.
			...
			PropertyChangeListener 
{
	...
	/**
	 * Creates a <code>VerticalTextIcon</code> for the specified <code>component</code>
	 * with the specified <code>label</code>.
	 * It sets the orientation to the default for the string
	 * @see #verifyRotation
	 */
	public 	VerticalTextIcon
			( Component 	component, 
			  String 	label ) 
	{
   ...
   /**
	 ...
	 */
	public static int 	verifyRotation
						( String 	label, 
						  int 		rotateHint ) 
	{
